        ...
        <SectionReveal delay={0.2}>
          <div className="shadow-2xl border border-border bg-gradient-to-b from-background/80 to-background/90 p-12 md:p-16 max-w-3xl mx-auto">
            <div className="space-y-8">
              <div>
                <h2 className="text-2xl font-bold mb-4 text-primary italic">Acceptance of Terms</h2>
              ...
              <div>
                <h2 className="text-2xl font-bold mb-4 text-primary italic">Use License</h2>
                <p className="text-muted-foreground leading-relaxed">
              ...
              <div>
                <h2 className="text-2xl font-bold mb-4 text-primary italic">Disclaimer</h2>
                <p className="text-muted-foreground leading-relaxed">
              ...
              <div>
                <h2 className="text-2xl font-bold mb-4 text-primary italic">Limitations</h2>
                <p className="text-muted-foreground leading-relaxed">
              ...
              <div>
                <h2 className="text-2xl font-bold mb-4 text-primary italic">Privacy Policy</h2>
                <p className="text-muted-foreground leading-relaxed">
              ...
              <div>
                <h2 className="text-2xl font-bold mb-4 text-primary italic">Contact Information</h2>
                <p className="text-muted-foreground leading-relaxed">
